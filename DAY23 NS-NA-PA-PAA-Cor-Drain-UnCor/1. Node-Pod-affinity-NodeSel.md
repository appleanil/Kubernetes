...
1. Label the Node:
```bash
kubectl label nodes node1 server=frontend        #ekkada manam yemina ivvachu eg env=prod, db=mongo alaga, disk=ssd
```
...
kubernetes.io/hostname        = Same Node / Different Node
    ...
    podAffinity:
      ...
      - labelSelector:
          ...
          - key: app
            ...
            values:
            - frontend
        topologyKey: "kubernetes.io/hostname"   #dnt worry abt region singapore, hyd, mumbai and zone or data centers like ap-south-1a, ap-south-1b...
  containers:
  - name: nginx
    image: nginx
```
