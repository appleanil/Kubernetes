...
Defination -- “Init containers are used to perform pre-start tasks like dependency checks, configuration setup, or migrations, ensuring the main application container starts in a ready state.”
...
spec:
  containers:
  - name: main-app
    image: anildocker11/maven:0.0.1
