    ...
    spec:
      ...
      - name: javawebappcon
        ...
        resources:
          requests:
            memory: "250Mi"
            cpu: "600m"  #first check with 600m and later use "1" means cpu
          limits:
            memory: "250Mi"
            cpu: "900m"   # first check with 900m and later use "1" means cpu
        ports:
        - containerPort: 8080
---
apiVersion: v1
...
```bash
kubectl describe pod <pod-name> -n test-ns  #kubectl describe nodes
```
