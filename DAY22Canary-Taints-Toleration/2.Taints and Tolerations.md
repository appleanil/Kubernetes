...
Case: 01 Node 1 ki nenu taints cheysanu with some conditions like key=value:NoSchedule so Pods kuda aa condition statisfy ithy aa node lo deploy avthundi leduante 
...
kubectl taint nodes <node1>environment=production:NoSchedule-    #untaints
```
