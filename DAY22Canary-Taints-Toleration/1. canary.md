...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: myapp
        image: nginxdemos/hello        #anildocker11/maven:0.0.1 or kkeducationb2/java-webapp:1.1
        ports:
        - containerPort: 80
```
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: myapp
        image: nginxdemos/hello            #anildocker11/maven:0.0.2 or kkeducationb2/java-webapp:1.1
        ports:
        - containerPort: 80
```
